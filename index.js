export const images = [
  {
    path: "./assets/imgs1/01.jpg",
    position: { top: "-5%", left: "5%" },
    speed: 0.08,
  },
  {
    path: "./assets/imgs1/02.jpg",
    position: { top: "25%", left: "20%" },
    speed: 0.03,
  },
  {
    path: "./assets/imgs1/03.jpg",
    position: { top: "60%", left: "40%" },
    speed: 0.065,
  },
  {
    path: "./assets/imgs1/04.jpg",
    position: { top: "70%", left: "10%" },
    speed: 0.04,
  },
  {
    path: "./assets/imgs1/05.jpg",
    position: { top: "-10%", left: "65%" },
    speed: 0.025,
  },
  {
    path: "./assets/imgs1/06.jpg",
    position: { top: "10%", left: "85%" },
    speed: 0.05,
  },
  {
    path: "./assets/imgs1/07.jpg",
    position: { top: "40%", left: "60%" },
    speed: 0.025,
  },
  {
    path: "./assets/imgs1/08.jpg",
    position: { top: "80%", left: "70%" },
    speed: 0.1,
  },
  {
    path: "./assets/imgs1/09.jpg",
